...
- `npm run dev` — run the Metabuffed frontend (port 25750)
- `npm run dev -w @workspace/api-server` — run the API server (port 5000)
...
- npm workspaces under `artifacts/*`, `lib/*`, and `scripts`
