        ...
        <section id="games" className="py-32 bg-black relative z-10">
          <div className="container mx-auto px-6">
            ...
            <div className="grid lg:grid-cols-3 gap-6 mb-6">
              ...
              >
                <img src={fightNightImg} alt="Fight Night Champion" className="absolute inset-0 w-full h-full object-cover object-top scale-100 group-hover:scale-105 transition-transform duration-700" />
